...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    changes: [
      ...
      { kind: "feature", text: "New enemies: skeletons that swing a broadsword, and skeleton-mages that hex you with staff bolts from range" },
      { kind: "feature", text: "The beasts' weapons (Beast Sword / Axe / Mace) are real weapons you can find and wield too" },
